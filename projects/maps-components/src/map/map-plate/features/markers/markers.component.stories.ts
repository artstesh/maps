...
const layerSettings = new FeatureLayerSettings().setStyle((s) => MarkerStyleHelper.circle(10, '#fff', '#ff0000'));
...
export const CustomMarker: Story = {
  ...
  args: {
    ...Primary.args,
    layerSettings: new FeatureLayerSettings().setStyle((s) => MarkerStyleHelper.fromSvg(markerSvg)),
  } as any,
};
